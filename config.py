...
class Config:
    ...
    # gemini-3.6-flash's free tier is capped at 20 requests/day — that's a real
    # constraint for Fix All / repeated testing (gemini-3.5-flash-lite has its own,
    # much higher per-model quota bucket) — chosen anyway for its higher patch quality.
