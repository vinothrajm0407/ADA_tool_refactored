  ...
  return (
    <div className="bg-white rounded-2xl border border-teal/10 overflow-hidden">
      ...
      >
        ...
        <ChevronRight
          size={15}
          className={`text-body transition-transform ${collapsed ?'':'rotate-90'}`}
        />
      </button>
      ...
      {!collapsed && (
        <div className="p-5 space-y-5">
          {/* Overall health */}
          {data.overall_health && (
            <div className="bg-teal/5 rounded-xl px-4 py-3">
          ...
          <p className="text-[10px] text-body pt-1 border-t border-gray-100">
