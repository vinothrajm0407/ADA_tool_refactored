        ...
        <div className="w-full max-w-sm">
          <div className="card p-8">
            {registered ? (
              ...
              /* ── Registration form ── */
              <>
                <h1 className="font-heading font-bold text-2xl text-ink mb-1">Create your account</h1>
                <p className="text-sm text-body mb-7">Start using ADA Accessibility Intelligence</p>
